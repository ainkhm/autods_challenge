        ...
        <div className="flex items-center gap-4">
          <div className="relative h-5">
            <input
              ...
              value={type}
              name="paymendMethod"
              className="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-full border border-blue-gray-200 transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-blue-gray-500 before:opacity-0 before:transition-opacity checked:border-purbg-purplish-blue checked:bg-accent-color checked:before:bg-accent-color"
              id={name}
              checked={isSelected}
              onChange={onChange}
            />
          ...
          <div className="flex flex-col">
            <p className="text-accent-color font-semibold tracking-tight">{name}</p>
          </div>
        </div>
