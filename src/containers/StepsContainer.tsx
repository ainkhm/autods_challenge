...
export const StepsContainer = () => {
  ...
  return (
    <div className="h-full flex flex-col px-6 md:px-16 pt-8 pb-4">
      <h1 className="rounded-t-xl pt-10 pb-4 px-6 md:p-0 text-2xl md:text-3xl text-accent-color font-bold md:mb-2">
        {title}
      </h1>
      <p className="px-6 md:px-0 pr-16 md:pr-4 text-accent-color tracking-tight md:mb-8 md:font-medium">{description}</p>
      {renderElement}
    </div>
  )
}